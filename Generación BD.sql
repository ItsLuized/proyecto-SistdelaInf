...
(2, 'Planeador', 'CRUD de planes estratégicos y operativos, puede evaluar acciones'),
(3, 'Líder Imperativo', 'Permisos sobre el imperativo que pertenezca, craer acciones y evaluarlas'),
...
VALUES 
(1, 'Plan Estratégico', 'Todos pueden ver la estructura. El planeador crear imperativos, objetivos y actividades clave y los ejecutores crean acciones y se evalúan'),
(2, 'Plan Operativo', 'Exclusiva por cargo. Los ejecutores solo pueden ver la estructura de cargo, acción y operación. El planeador puede ver todas las acciones de todos los cargos');
